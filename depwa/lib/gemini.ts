...
3. スタイル指定：
   ...
   - 作図の方向（横向きあど）指定された場合は、指示に従い昨図

4. 配色やスタイルについて：
  - デフォルトの配色は、UCDAの原則に従い、わかりやすい配色を心がけてください。
  - テーマを指定された場合、テーマに従い配色を使用すること。
  - テーマやカラーに関する補足情報：https://mermaid.js.org/config/theming.html
...
- 公式サイト：https://plantuml.com/ja-dark/
- 色に関する補足情報：https://plantuml.com/ja-dark/color
